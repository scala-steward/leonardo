...
HELP_TEXT="$(cat <<EOF
 ...
 Examples:
   Builds and pushes the Jupyter docker image
    ./tools/common/build.sh --push -i jupyter -r us.gcr.io/broad-dsp-gcr-public -t 12345 -b my-branch
   Builds the RStudio docker image tagged with the git branch name
    ./tools/common/build.sh -i rstudio -r us.gcr.io/broad-dsp-gcr-public -t my-tag
\t
EOF
)"
